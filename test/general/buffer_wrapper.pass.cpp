...
main()
{
    ...
    test(oneapi::dpl::begin(buf, sycl::write_only, __no_init{}), oneapi::dpl::end(buf, sycl::write_only, __no_init{}), data_ptr, size);
    test(oneapi::dpl::begin(buf, __no_init{}), oneapi::dpl::end(buf, __no_init{}), data_ptr, size);
