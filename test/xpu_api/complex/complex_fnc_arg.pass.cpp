...
protected:
    ...
    void test_arg()
    {
        ...
        EXPECT_TRUE_EE(errorEngine, arg_res == arg_res_expected, "Wrong result if dpl::arg(dpl::complex<T>()) function");
    }
    ...
    void test_arg_for_non_complex_arg(T val)
    {
        ...
        EXPECT_TRUE_EE(errorEngine, arg_res == arg_res_expected, "Wrong result if dpl::arg(dpl::complex<T>()) function #1");
    }
    ...
    void test_arg_edges()
    {
        ...
        for (unsigned i = 0; i < N; ++i)
        {
            ...
            EXPECT_TRUE_EE(errorEngine, arg_res == arg_res_expected, "Wrong result if dpl::arg(dpl::complex<T>()) function #2");
        }
    }
