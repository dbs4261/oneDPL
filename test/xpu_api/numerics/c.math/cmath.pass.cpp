...
#error isgreater defined
    ...
    IF_DOUBLE_SUPPORT(static_assert((std::is_same<decltype(dpl::isgreater((float)0, (double)0)), bool>::value), "");
...
#error isgreaterequal defined
    ...
    IF_DOUBLE_SUPPORT(static_assert((std::is_same<decltype(dpl::isgreaterequal((float)0, (double)0)), bool>::value), "");
...
#error isless defined
    ...
    IF_DOUBLE_SUPPORT(static_assert((std::is_same<decltype(dpl::isless((float)0, (double)0)), bool>::value), "");
...
#error islessequal defined
    ...
    IF_DOUBLE_SUPPORT(static_assert((std::is_same<decltype(dpl::islessequal((float)0, (double)0)), bool>::value), "");
...
#error isunordered defined
    ...
    IF_DOUBLE_SUPPORT(static_assert((std::is_same<decltype(dpl::isunordered((float)0, (double)0)), bool>::value), "");
...
void test_round()
{
    ...
    IF_LONG_DOUBLE_SUPPORT(static_assert((std::is_same<decltype(dpl::round((long long)0)), double>::value), "");
